...
function task_5()
	...
	task(function()
		...
		for i = 0,31 do
			...
			seq('1111',0.125,
			function()
				bullet(0,0,24+t*1.5,x*9.32)
				bullet(0,0,24+t*1.5,120+x*9.32)
				bullet(0,0,24+t*1.5,240+x*9.32)
				x=x+1
				t=t+1
			end)
		end
		...
		if i > 3 then
			task(function()
				...
				seq('1010001010010010100100100010001', 0.25, function()
					...
					for j = 0,1 do
						att:bullet(0, 0, 160, j*3);
						att:bullet(0, 0, 160, 240+j*3);
						att:bullet(0, 0, 160, 120+j*3);
					end
					att:setAcc(-160);
					att:setAcc(0,1);
					att:setSpeed(20,2);
...
function task_9()
	...
	task(function()
		...
		seq('1000000010000000100010001010111',1,function()
			...
			for j = 0,59 do
				bullet(x, y, 40, j*6);
				bullet(x, -300-y, 40, j*6);
				bullet(800-x, y, 40, j*6);
				bullet(-800-x, y, 40, j*6);
			end
		end);
	end);
			...
			task(function()
				...
				seq('1010001010010010100100100010001', 0.25, function()
					...
					for j = 0,1 do
						...
						att:bullet(0, 0, 120, 240+j*3);
						att:bullet(0, 0, 120, 120+j*3);
					end
					att:setAcc(-120);
					att:setAcc(0,1);
					att:setSpeed(20,3);
	...
	for i = 0,3 do
		...
		task(function()
			...
			for t = 0,3 do
				att = Attach.new();
				for j = 0,11 do
					att:bullet(0,0,190,j*30);
					att:bullet(0,0,195,j*30+15);
				end
				att:setAcc(-160);
				sleep(1);
				att:setAcc(0);
				att = Attach.new();
				for j = 0,11 do
					att:bullet(0,0,195,j*30);
					att:bullet(0,0,190,j*30+15);
				end
				att:setAcc(-160);
				sleep(1);
				att:setAcc(0);
	...
	for i = 0,3 do
		task(function()
			...
			for t = 0,3 do
				att = Attach.new();
				for j = 0,14 do
					att:bullet(0,0,190,j*24);
					att:bullet(0,0,195,j*24+12);
				end
				att:setAcc(-160);
				sleep(1);
				att:setAcc(0);
				att = Attach.new();
				for j = 0,14 do
					att:bullet(0,0,195,j*24);
					att:bullet(0,0,190,j*24+12);
				end
				att:setAcc(-160);
				sleep(1);
				att:setAcc(0);
